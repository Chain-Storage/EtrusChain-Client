...
import { requestAccount } from "../components/Navbars/IndexNavbar";

import landingPageSvg from "../assets/img/img_loopergroup.svg";
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Elevate your cloud storage experience with our decentralized
                solution
              </h2>
              ...
              <div className="mt-12" onClick={requestAccount}>
                ...
                <a
                  href="https://github.com/Chain-Storage"
